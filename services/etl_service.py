...
class ETLPipeline:
    ...
    def EvaluationAgent(self, input_json):

        prompt = """
You are a assignement evaluation expert. Given the extracted content from a student's assignment submission and the assignment questions paper, your task is to evaluate the submission.
""" + str(input_json)
